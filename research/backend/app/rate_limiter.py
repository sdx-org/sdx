...
# Global instances
diagnosis_rate_limiter = RateLimiter(max_calls=5, time_window=3600)  # 5 per hour per patient
exam_rate_limiter = RateLimiter(max_calls=5, time_window=3600)       # 5 per hour per patient
ip_rate_limiter = RateLimiter(max_calls=100, time_window=3600)       # 100 per hour per IP
